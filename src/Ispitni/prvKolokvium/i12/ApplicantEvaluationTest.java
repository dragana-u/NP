package Ispitni.prvKolokvium.i12;
...
class NoCriminalRecordAndMoreExperience implements Evaluator{
...
class MoreExperienceAndMoreCreditScore implements Evaluator{

    @Override
    public boolean evaluate(Applicant applicant) {
        return (applicant.getEmploymentYears()>=10
                && applicant.getCreditScore()>=500);
    }
}

class NoCriminalRecordAndMoreCreditScore implements Evaluator{
