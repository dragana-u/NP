package Ispitni.prvKolokvium.i10;
...
interface IEvaluator<E> {
    boolean evaluate (E a, E b);
}
class EvaluatorBuilder{
    static <E extends Comparable<E>> IEvaluator<E> build (String operator){
        if(operator.equals(">")){
...
class Evaluator{
    static <E extends Comparable<E>> boolean evaluateExpression (E left, E right, String operator){
        IEvaluator<E> evaluator = EvaluatorBuilder.build(operator);
